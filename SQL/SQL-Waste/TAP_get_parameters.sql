SELECT * FROM ewc_noise_monitoring_location WHERE id = 1;
SELECT * FROM ewc_noise_monitoring_location_parameters WHERE noise_monitoring_location_id = 1;
SELECT * FROM ewc_noise;
SELECT * FROM ewc_noise WHERE id = 32;
SELECT * FROM ewc_noise_noise_monitoring_location_setup WHERE noise_id = 32;

SELECT * FROM gat_observations AS o WHERE o.id = 271;  -- WHERE o.environmental_emissions_id = 0; --  AND o.source_id = 111;
...
SELECT
        ...
        -- WHERE n.country_id = 6 AND n.site_id = 38 AND(d_b.country_id = 6 OR (d_c.country_id = 6 AND d_c.site_id = 38))
				WHERE n.id = 1 AND (d_b.country_id = 6 OR (d_c.country_id = 6 AND d_c.site_id = 38) OR d_a.corporate_max_limit > 0 OR d_a.corporate_min_limit > 0);
