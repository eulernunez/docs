SELECT * FROM ewc_air_quality_monitoring_locations WHERE id IN (10, 11, 12);
...
SELECT DISTINCT
                            ...
                            FROM ewc_air_quality_monitoring_locations AS n 
                                    ...
                                    WHERE n.id = 10 AND (d_b.country_id = 6 OR (d_c.country_id = 6 AND d_c.site_id = 40) OR d_a.corporate_max_limit > 0 OR d_a.corporate_min_limit > 0)